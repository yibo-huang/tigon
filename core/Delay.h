...
class SameDelay : public Delay {
    public:
	SameDelay(std::size_t coordinator_id, std::size_t coordinator_num, int64_t delay_time)
		: Delay(coordinator_id, coordinator_num)
	...
	int64_t message_delay() const override
	{
		return delay_time;
	}

	bool delay_enabled() const override
	{
		return delay_time != 0;
	}
