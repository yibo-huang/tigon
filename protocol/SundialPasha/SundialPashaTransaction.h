...
class SundialPashaTransaction {
                        ...
                        uint64_t limit, void *results, std::size_t granule_id = 0)
	{
		...
		scanKey.set_partition_id(partition_id);
                ...
                scanKey.set_scan_args(&min_key, &max_key, limit, results, SundialPashaRWKey::SCAN_FOR_READ);
                        ...
                        uint64_t limit, void *results, std::size_t granule_id = 0)
	{
		...
		scanKey.set_partition_id(partition_id);
                ...
                scanKey.set_scan_args(&min_key, &max_key, limit, results, SundialPashaRWKey::SCAN_FOR_UPDATE);
                        ...
                        uint64_t limit, void *results, std::size_t granule_id = 0)
	{
		...
		scanKey.set_partition_id(partition_id);
                ...
                scanKey.set_scan_args(&min_key, &max_key, limit, results, SundialPashaRWKey::SCAN_FOR_INSERT);
                        ...
                        uint64_t limit, void *results, std::size_t granule_id = 0)
	{
		...
		scanKey.set_partition_id(partition_id);
                ...
                scanKey.set_scan_args(&min_key, &max_key, limit, results, SundialPashaRWKey::SCAN_FOR_DELETE);
