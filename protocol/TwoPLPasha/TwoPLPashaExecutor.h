		...
		: base_type(coordinator_id, id, db, context, worker_status, n_complete_workers, n_started_workers)
	{
                if (id == 0) {
                        ...
                        if (context.pre_migrate == "None") {
                                ...
                                db.move_all_tables_into_cxl(std::bind(&TwoPLPashaHelper::move_from_partition_to_shared_region, twopl_pasha_global_helper, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4));
                        } else if (context.pre_migrate == "NonPart") {
                                db.move_non_part_tables_into_cxl(std::bind(&TwoPLPashaHelper::move_from_partition_to_shared_region, twopl_pasha_global_helper, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4));
                        } else {
                                CHECK(0);
                        }
