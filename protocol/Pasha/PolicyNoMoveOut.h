...
class PolicyNoMoveOut : public MigrationManager {
    public:
        PolicyNoMoveOut(std::function<bool(ITable *, const void *, const std::tuple<std::atomic<uint64_t> *, void *> &)> move_from_partition_to_shared_region,
        ...
        {
                return move_from_partition_to_shared_region(table, key, row);
        }
