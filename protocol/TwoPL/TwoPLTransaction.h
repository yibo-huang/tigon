...
class TwoPLTransaction {
	...
	TwoPLTransaction(std::size_t coordinator_id, std::size_t partition_id, Partitioner &partitioner, std::size_t ith_replica)
                        ...
                        uint64_t limit, void *results, std::size_t granule_id = 0)
	{
		...
		scanKey.set_partition_id(partition_id);
                ...
                scanKey.set_scan_args(&min_key, &max_key, limit, results, TwoPLRWKey::SCAN_FOR_READ);
                        ...
                        uint64_t limit, void *results, std::size_t granule_id = 0)
	{
		...
		scanKey.set_partition_id(partition_id);
                ...
                scanKey.set_scan_args(&min_key, &max_key, limit, results, TwoPLRWKey::SCAN_FOR_UPDATE);
                        ...
                        uint64_t limit, void *results, std::size_t granule_id = 0)
	{
		...
		scanKey.set_partition_id(partition_id);
                ...
                scanKey.set_scan_args(&min_key, &max_key, limit, results, TwoPLRWKey::SCAN_FOR_INSERT);
                        ...
                        uint64_t limit, void *results, std::size_t granule_id = 0)
	{
		...
		scanKey.set_partition_id(partition_id);
                ...
                scanKey.set_scan_args(&min_key, &max_key, limit, results, TwoPLRWKey::SCAN_FOR_DELETE);
