...
class CalvinHelper {
	...
	static std::size_t n_lock_manager(std::size_t replica_group_id, std::size_t id, const std::vector<std::size_t> &lock_managers)
	{
	...
	static std::size_t partition_id_to_lock_manager_id(std::size_t partition_id, std::size_t n_lock_manager, std::size_t replica_group_size)
	{
