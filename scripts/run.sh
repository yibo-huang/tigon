...
if [ $RUN_TYPE = "TPCC" ]; then
        ...
        run_exp_ycsb TwoPLPasha $HOST_NUM $WORKER_NUM mixed 40960 50 0 10 1 $PASHA_CXL_TRANS_ENTRY_STRUCT_SIZE $PASHA_CXL_TRANS_ENTRY_NUM OnDemandFIFO OnDemand 1000 WriteThrough None 10 5 0
