...
if len(sys.argv) != 2:
        print("Usage: ./plot_tpcc_migration_policy.py res_dir")
        sys.exit(-1)
...
### plot TPCC ###
res_csv = res_dir + "/tpcc-migration-policy.csv"
...
plt.savefig(res_dir + "tpcc-migration-policy.pdf", format="pdf", bbox_inches="tight")
