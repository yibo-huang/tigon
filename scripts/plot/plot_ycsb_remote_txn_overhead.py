...
### plot TPCC ###
res_csv = res_dir + "/ycsb-remote-txn-overhead-" + rw_ratio + "-" + zipf_theta + ".csv"
...
plt.savefig(res_dir + "ycsb-remote-txn-overhead-" + rw_ratio + "-" + zipf_theta + ".pdf", format="pdf", bbox_inches="tight")
