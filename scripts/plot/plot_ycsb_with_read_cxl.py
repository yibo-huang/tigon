...
### plot TPCC ###
res_csv = res_dir + "/ycsb-with-read-cxl-" + rw_ratio + "-" + zipf_theta + ".csv"
...
tigon_read_cxl_y = res_df["Tigon-ReadCXL"]
...
tmp_list.extend(tigon_read_cxl_y)
...
plt.plot(x, tigon_read_cxl_y, color="#CD5C5C", marker="s", markersize=marker_size, linewidth=linewidth, markeredgewidth=marker_edge_width, mfc='none', label="Tigon-ReadCXL")
...
plt.savefig(res_dir + "/ycsb-with-read-cxl-" + rw_ratio + "-" + zipf_theta + ".pdf", format="pdf", bbox_inches="tight")
