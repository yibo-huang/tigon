...
### plot TPCC ###
res_csv = res_dir + "/tpcc-shortcut.csv"
...
plt.plot(x, tigon_no_shortcut_y, color="#62615d", marker=">", markersize=marker_size, linewidth=linewidth, markeredgewidth=marker_edge_width, mfc='none', label="Tigon-AlwaysSearchCXL")

# Configure legend
ax.legend(loc='upper center', frameon=False, fancybox=False, framealpha=1, ncol=2, prop={**basic_font})

plt.savefig(res_dir + "/tpcc-shortcut.pdf", format="pdf", bbox_inches="tight")
