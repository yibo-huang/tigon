...
def construct_input_list_ycsb(pasha_res_dir, baseline_res_dir, rw_ratio, zipf_theta):
        input_file_list = list()
        input_file_list.append(("Tigon", pasha_res_dir + "/ycsb-TwoPLPasha-rmw-8-3-" + rw_ratio + "-" + zipf_theta + "-1-0-" + "Clock" + "-" + "OnDemand" + "-" + "209715200" + "-" + "WriteThrough" + "-" + "NonPart" + "-" + "GROUP_WAL-40000" + "-" + "0" + ".txt"))
...
def construct_input_list_ycsb_custom(pasha_res_dir, zipf_theta):
        input_file_list = list()
        input_file_list.append(("Tigon", pasha_res_dir + "/ycsb-TwoPLPasha-mixed-8-3-100" + "-" + zipf_theta + "-1-0-" + "NoMoveOut" + "-" + "OnDemand" + "-" + "209715200" + "-" + "WriteThrough" + "-" + "NonPart" + "-" + "GROUP_WAL-40000" + "-" + "0" + ".txt"))
        return input_file_list
...
def construct_input_list_ycsb_with_read_cxl(pasha_res_dir, baseline_res_dir, rw_ratio, zipf_theta):
        input_file_list = list()
        input_file_list.append(("Tigon", pasha_res_dir + "/ycsb-TwoPLPasha-rmw-8-3-" + rw_ratio + "-" + zipf_theta + "-1-0-" + "Clock" + "-" + "OnDemand" + "-" + "209715200" + "-" + "WriteThrough" + "-" + "NonPart" + "-" + "GROUP_WAL-40000" + "-" + "0" + ".txt"))
        input_file_list.append(("Tigon-ReadCXL", pasha_res_dir + "/ycsb-TwoPLPashaReadCXL-rmw-8-3-" + rw_ratio + "-" + zipf_theta + "-1-0-" + "Clock" + "-" + "OnDemand" + "-" + "209715200" + "-" + "WriteThrough" + "-" + "NonPart" + "-" + "GROUP_WAL-40000" + "-" + "0" + ".txt"))
...
def construct_input_list_tpcc(pasha_res_dir, baseline_res_dir):
        input_file_list = list()
        input_file_list.append(("Tigon", pasha_res_dir + "/tpcc-TwoPLPasha-8-3-1-0-" + "Clock" + "-" + "OnDemand" + "-" + "209715200" + "-" + "WriteThrough" + "-" + "NonPart" + "-" + "GROUP_WAL-40000" + "-" + "0" + ".txt"))
        input_file_list.append(("Tigon-Phantom", pasha_res_dir + "/tpcc-TwoPLPashaPhantom-8-3-1-0-" + "Clock" + "-" + "OnDemand" + "-" + "209715200" + "-" + "WriteThrough" + "-" + "NonPart" + "-" + "GROUP_WAL-40000" + "-" + "0" + ".txt"))
...
def construct_input_list_ycsb_shortcut(pasha_res_dir, pasha_no_shortcut_res_dir, rw_ratio, zipf_theta):
        input_file_list = list()
        input_file_list.append(("Tigon", pasha_res_dir + "/ycsb-TwoPLPasha-rmw-8-3-" + rw_ratio + "-" + zipf_theta + "-1-0-" + "Clock" + "-" + "OnDemand" + "-" + "209715200" + "-" + "WriteThrough" + "-" + "NonPart" + "-" + "GROUP_WAL-40000" + "-" + "0" + ".txt"))
        input_file_list.append(("Tigon-AlwaysSearchCXL", pasha_no_shortcut_res_dir + "/ycsb-TwoPLPasha-rmw-8-3-" + rw_ratio + "-" + zipf_theta + "-1-0-" + "Clock" + "-" + "OnDemand" + "-" + "209715200" + "-" + "WriteThrough" + "-" + "NonPart" + "-" + "GROUP_WAL-40000" + "-" + "1" + ".txt"))
        return input_file_list
...
def construct_input_list_tpcc_shortcut(pasha_res_dir, pasha_no_shortcut_res_dir):
        input_file_list = list()
        input_file_list.append(("Tigon", pasha_res_dir + "/tpcc-TwoPLPasha-8-3-1-0-" + "Clock" + "-" + "OnDemand" + "-" + "209715200" + "-" + "WriteThrough" + "-" + "NonPart" + "-" + "GROUP_WAL-40000" + "-" + "0" + ".txt"))
        input_file_list.append(("Tigon-AlwaysSearchCXL", pasha_no_shortcut_res_dir + "/tpcc-TwoPLPasha-8-3-1-0-" + "Clock" + "-" + "OnDemand" + "-" + "209715200" + "-" + "WriteThrough" + "-" + "NonPart" + "-" + "GROUP_WAL-40000" + "-" + "1" + ".txt"))
        return input_file_list
...
def construct_input_list_ycsb_data_movement(pasha_res_dir, pasha_data_movement_res_dir, rw_ratio, zipf_theta):
        input_file_list = list()
        input_file_list.append(("Tigon-200MB", pasha_res_dir + "/ycsb-TwoPLPasha-rmw-8-3-" + rw_ratio + "-" + zipf_theta + "-1-0-" + "Clock" + "-" + "OnDemand" + "-" + "209715200" + "-" + "WriteThrough" + "-" + "NonPart" + "-" + "GROUP_WAL-40000" + "-" + "0" + ".txt"))
        input_file_list.append(("Tigon-150MB", pasha_data_movement_res_dir + "/ycsb-TwoPLPasha-rmw-8-3-" + rw_ratio + "-" + zipf_theta + "-1-0-" + "Clock" + "-" + "OnDemand" + "-" + "157286400" + "-" + "WriteThrough" + "-" + "None" + "-" + "GROUP_WAL-40000" + "-" + "0" + ".txt"))
        input_file_list.append(("Tigon-100MB", pasha_data_movement_res_dir + "/ycsb-TwoPLPasha-rmw-8-3-" + rw_ratio + "-" + zipf_theta + "-1-0-" + "Clock" + "-" + "OnDemand" + "-" + "104857600" + "-" + "WriteThrough" + "-" + "None" + "-" + "GROUP_WAL-40000" + "-" + "0" + ".txt"))
        input_file_list.append(("Tigon-50MB", pasha_data_movement_res_dir + "/ycsb-TwoPLPasha-rmw-8-3-" + rw_ratio + "-" + zipf_theta + "-1-0-" + "Clock" + "-" + "OnDemand" + "-" + "52428800" + "-" + "WriteThrough" + "-" + "None" + "-" + "GROUP_WAL-40000" + "-" + "0" + ".txt"))
        input_file_list.append(("Tigon-10MB", pasha_data_movement_res_dir + "/ycsb-TwoPLPasha-rmw-8-3-" + rw_ratio + "-" + zipf_theta + "-1-0-" + "Clock" + "-" + "OnDemand" + "-" + "10485760" + "-" + "WriteThrough" + "-" + "None" + "-" + "GROUP_WAL-40000" + "-" + "0" + ".txt"))
        return input_file_list
...
def construct_input_list_tpcc_data_movement(pasha_res_dir, pasha_data_movement_res_dir):
        input_file_list = list()
        input_file_list.append(("Tigon-200MB", pasha_res_dir + "/tpcc-TwoPLPasha-8-3-1-0-" + "Clock" + "-" + "OnDemand" + "-" + "209715200" + "-" + "WriteThrough" + "-" + "NonPart" + "-" + "GROUP_WAL-40000" + "-" + "0" + ".txt"))
        input_file_list.append(("Tigon-150MB", pasha_data_movement_res_dir + "/tpcc-TwoPLPasha-8-3-1-0-" + "Clock" + "-" + "OnDemand" + "-" + "157286400" + "-" + "WriteThrough" + "-" + "None" + "-" + "GROUP_WAL-40000" + "-" + "0" + ".txt"))
        input_file_list.append(("Tigon-100MB", pasha_data_movement_res_dir + "/tpcc-TwoPLPasha-8-3-1-0-" + "Clock" + "-" + "OnDemand" + "-" + "104857600" + "-" + "WriteThrough" + "-" + "None" + "-" + "GROUP_WAL-40000" + "-" + "0" + ".txt"))
        input_file_list.append(("Tigon-50MB", pasha_data_movement_res_dir + "/tpcc-TwoPLPasha-8-3-1-0-" + "Clock" + "-" + "OnDemand" + "-" + "52428800" + "-" + "WriteThrough" + "-" + "None" + "-" + "GROUP_WAL-40000" + "-" + "0" + ".txt"))
        input_file_list.append(("Tigon-10MB", pasha_data_movement_res_dir + "/tpcc-TwoPLPasha-8-3-1-0-" + "Clock" + "-" + "OnDemand" + "-" + "10485760" + "-" + "WriteThrough" + "-" + "None" + "-" + "GROUP_WAL-40000" + "-" + "0" + ".txt"))
        return input_file_list
...
def construct_input_list_ycsb_logging(pasha_logging_res_dir, rw_ratio, zipf_theta):
        input_file_list = list()
        input_file_list.append(("Tigon-no-logging", pasha_logging_res_dir + "/ycsb-TwoPLPasha-rmw-8-3-" + rw_ratio + "-" + zipf_theta + "-1-0-" + "Clock" + "-" + "OnDemand" + "-" + "209715200" + "-" + "WriteThrough" + "-" + "NonPart" + "-" + "BLACKHOLE-0" + "-" + "0" + ".txt"))
        input_file_list.append(("Tigon-1ms", pasha_logging_res_dir + "/ycsb-TwoPLPasha-rmw-8-3-" + rw_ratio + "-" + zipf_theta + "-1-0-" + "Clock" + "-" + "OnDemand" + "-" + "209715200" + "-" + "WriteThrough" + "-" + "NonPart" + "-" + "GROUP_WAL-1000" + "-" + "0" + ".txt"))
        input_file_list.append(("Tigon-10ms", pasha_logging_res_dir + "/ycsb-TwoPLPasha-rmw-8-3-" + rw_ratio + "-" + zipf_theta + "-1-0-" + "Clock" + "-" + "OnDemand" + "-" + "209715200" + "-" + "WriteThrough" + "-" + "NonPart" + "-" + "GROUP_WAL-10000" + "-" + "0" + ".txt"))
        input_file_list.append(("Tigon-20ms", pasha_logging_res_dir + "/ycsb-TwoPLPasha-rmw-8-3-" + rw_ratio + "-" + zipf_theta + "-1-0-" + "Clock" + "-" + "OnDemand" + "-" + "209715200" + "-" + "WriteThrough" + "-" + "NonPart" + "-" + "GROUP_WAL-20000" + "-" + "0" + ".txt"))
        input_file_list.append(("Tigon-30ms", pasha_logging_res_dir + "/ycsb-TwoPLPasha-rmw-8-3-" + rw_ratio + "-" + zipf_theta + "-1-0-" + "Clock" + "-" + "OnDemand" + "-" + "209715200" + "-" + "WriteThrough" + "-" + "NonPart" + "-" + "GROUP_WAL-30000" + "-" + "0" + ".txt"))
        input_file_list.append(("Tigon-40ms", pasha_logging_res_dir + "/ycsb-TwoPLPasha-rmw-8-3-" + rw_ratio + "-" + zipf_theta + "-1-0-" + "Clock" + "-" + "OnDemand" + "-" + "209715200" + "-" + "WriteThrough" + "-" + "NonPart" + "-" + "GROUP_WAL-40000" + "-" + "0" + ".txt"))
        input_file_list.append(("Tigon-50ms", pasha_logging_res_dir + "/ycsb-TwoPLPasha-rmw-8-3-" + rw_ratio + "-" + zipf_theta + "-1-0-" + "Clock" + "-" + "OnDemand" + "-" + "209715200" + "-" + "WriteThrough" + "-" + "NonPart" + "-" + "GROUP_WAL-50000" + "-" + "0" + ".txt"))
        return input_file_list
...
def construct_input_list_tpcc_logging(pasha_logging_res_dir):
        ...
        input_file_list.append(("Tigon-1ms", pasha_logging_res_dir + "/tpcc-TwoPLPasha-8-3-1-0-" + "Clock" + "-" + "OnDemand" + "-" + "209715200" + "-" + "WriteThrough" + "-" + "NonPart" + "-" + "GROUP_WAL-1000" + "-" + "0" + ".txt"))
        input_file_list.append(("Tigon-10ms", pasha_logging_res_dir + "/tpcc-TwoPLPasha-8-3-1-0-" + "Clock" + "-" + "OnDemand" + "-" + "209715200" + "-" + "WriteThrough" + "-" + "NonPart" + "-" + "GROUP_WAL-10000" + "-" + "0" + ".txt"))
        input_file_list.append(("Tigon-20ms", pasha_logging_res_dir + "/tpcc-TwoPLPasha-8-3-1-0-" + "Clock" + "-" + "OnDemand" + "-" + "209715200" + "-" + "WriteThrough" + "-" + "NonPart" + "-" + "GROUP_WAL-20000" + "-" + "0" + ".txt"))
        input_file_list.append(("Tigon-30ms", pasha_logging_res_dir + "/tpcc-TwoPLPasha-8-3-1-0-" + "Clock" + "-" + "OnDemand" + "-" + "209715200" + "-" + "WriteThrough" + "-" + "NonPart" + "-" + "GROUP_WAL-30000" + "-" + "0" + ".txt"))
        input_file_list.append(("Tigon-40ms", pasha_logging_res_dir + "/tpcc-TwoPLPasha-8-3-1-0-" + "Clock" + "-" + "OnDemand" + "-" + "209715200" + "-" + "WriteThrough" + "-" + "NonPart" + "-" + "GROUP_WAL-40000" + "-" + "0" + ".txt"))
        input_file_list.append(("Tigon-50ms", pasha_logging_res_dir + "/tpcc-TwoPLPasha-8-3-1-0-" + "Clock" + "-" + "OnDemand" + "-" + "209715200" + "-" + "WriteThrough" + "-" + "NonPart" + "-" + "GROUP_WAL-50000" + "-" + "0" + ".txt"))
        return input_file_list
