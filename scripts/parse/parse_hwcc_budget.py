...
def construct_input_list_ycsb_hwcc_budget(hwcc_budget_res_dir, rw_ratio, zipf_theta):
        ...
        input_file_list.append(("Tigon-200MB", hwcc_budget_res_dir + "/ycsb-TwoPLPasha-rmw-8-3-" + rw_ratio + "-" + zipf_theta + "-1-0-Clock-OnDemand-209715200-1-WriteThrough-NonPart-GROUP_WAL-20000-0.txt"))
...
def construct_input_list_tpcc_hwcc_budget(hwcc_budget_res_dir):
        input_file_list = list()
        input_file_list.append(("Tigon-200MB", hwcc_budget_res_dir + "/tpcc-TwoPLPasha-8-3-1-0-Clock-OnDemand-209715200-1-WriteThrough-NonPart-GROUP_WAL-20000-0.txt"))
